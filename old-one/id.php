...
<body>
    ...
    <div class="main-wrapper" style="position: relative; top: -6vh;">
        <div class="container main-sentence justify-content-center text-center">
            ...
            <br>
            <span id="sentence" style="font-size: 1rem;"><?php echo $rand; ?></span>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    ...
                    <span class="btn btn-primary btn-filled btn-xs"><a class="btn btn-primary btn-filled btn-xs" href="http://www.nows.fun">ericxin.cf</a></span>
                </div>
            </div>
        </div>
    </div>
