...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    ...
                    <!--<span class="btn btn-primary btn-filled btn-xs"><a class="btn btn-primary btn-filled btn-xs" href="http://www.ericxin.cf">ericxin.cf</a></span>-->
                    <span class="btn btn-primary btn-filled btn-xs"><a class="btn btn-primary btn-filled btn-xs" type="button" value="生成" onclick="hello()" >ericxin.cf</a></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!--<input type="button" value="生成" onclick="hello()" />-->
